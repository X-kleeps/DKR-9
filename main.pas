...
fEdit1.Telefon1Edit.Text:= '';
fEdit1.Pol1ComboBox.Text:= '';
fEdit1.Class1ComboBox.Text:= '';
fEdit1.ShowModal;

  if (fEdit1.Fio1Edit.text= '') or (fEdit1.Telefon1Edit.text= '') then exit;
...
SQLQuery1.ParamByName('i').AsString :=fEdit1.Telefon1Edit.text;
SQLQuery1.ParamByName('j').AsString :=fEdit1.Pol1ComboBox.text;
SQLQuery1.ParamByName('h').AsString :=fEdit1.Class1ComboBox.text;
